...
AGENT_TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "create_file",
            "description": "Create or overwrite a file. Shows a diff review.",
            "parameters": {
                "type": "object",
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Ingest a file into the knowledge base (RAG)",
            "parameters": {
                "type": "object",
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Learn facts from text",
            "parameters": {
                "type": "object",
                "properties": {"text": {"type": "string"}, "cid": {"type": "string"}},
                "required": ["text"],
            },
        },
    },
    {
        ...
        "function": {
            ...
            "description": "Search the local knowledge base (RAG retrieval)",
            "parameters": {
                "type": "object",
                "properties": {"query": {"type": "string"}},
                "required": ["query"],
    ...
    },
    {
        ...
        "function": {
            "name": "spawn_subagent",
            "description": "Spawn a parallel subagent to work on a task. Returns the agent_id. Max 4 subagents.",
            "parameters": {
                "type": "object",
                "properties": {
                    "task": {"type": "string"},
                    "mode": {"type": "string", "enum": ["worker", "explorer"]},
                },
                "required": ["task"],
            },
        },
    },
    {
        ...
        "function": {
            ...
            "description": "Get results from all spawned subagents.",
            "parameters": {"type": "object", "properties": {}},
        },
    },
]
...
def execute_tool(name, args):
    ...
    dispatch = {
        ...
        "edit_file": lambda a: edit_file(
            a.get("path", ""), a.get("old_text", ""), a.get("new_text", "")
        ),
