...
class MessageFrame(QFrame):
    def __init__(self, role, text, on_like=None, on_dislike=None, on_regenerate=None, on_speak=None, msg_id=None):
        super().__init__()
        ...
        if role == 'assistant':
            for label, fn, width in [('👍', on_like, 40), ('👎', on_dislike, 40), ('🔄', on_regenerate, 60), ('🔊', on_speak, 50)]:
